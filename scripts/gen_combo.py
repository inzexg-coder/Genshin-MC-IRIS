...
# касание у плеча).
CLIPS = [
    # --- hit1: smooth-дизайн v8, ЗЕРКАЛО применено (игровые стороны) ---
    [
        ...
        (0.675, E_LINEAR, P(rYaw=-33.7, rPitch=-56.7, rRoll=7.4, lPitch=-18.7, lRoll=3.7, bYaw=-5.0, bPitch=2.0, rlPitch=34.2, llPitch=-10.5)),
        (0.700, E_LINEAR, P(rYaw=-43.3, rPitch=-56.4, rRoll=4.2, lPitch=-17.1, lRoll=2.1, bYaw=-3.7, bPitch=2.0, rlPitch=33.3, llPitch=-11.2)),
        (0.725, E_LINEAR, P(rYaw=-49.7, rPitch=-56.2, rRoll=2.1, lPitch=-16.0, lRoll=1.0, bYaw=-2.8, bPitch=2.0, rlPitch=32.6, llPitch=-11.6)),
        (0.750, E_LINEAR, P(rYaw=-53.5, rPitch=-56.1, rRoll=0.8, lPitch=-15.4, lRoll=0.4, bYaw=-2.3, bPitch=2.0, rlPitch=32.3, llPitch=-11.8)),
        (0.775, E_LINEAR, P(rYaw=-55.3, rPitch=-56.0, rRoll=0.2, lPitch=-15.1, lRoll=0.1, bYaw=-2.1, bPitch=2.0, rlPitch=32.1, llPitch=-12.0)),
        (0.800, E_LINEAR, P(rYaw=-55.9, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.825, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.850, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.875, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.900, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.925, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.950, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.975, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (1.000, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
    ],
    # --- hit2: smooth-дизайн v8, ЗЕРКАЛО применено (игровые стороны) ---
    [
        (0.000, E_LINEAR, P(rYaw=-56.0, rPitch=-56.0, lPitch=-15.0, bYaw=-2.0, bPitch=2.0, rlPitch=32.0, llPitch=-12.0)),
        (0.025, E_LINEAR, P(rYaw=-51.9, rPitch=-52.3, rRoll=-1.5, lPitch=-20.6, lRoll=-4.4, bYaw=-2.4, bPitch=1.6, rlPitch=26.1, llPitch=-6.1)),
        (0.050, E_LINEAR, P(rYaw=-45.7, rPitch=-46.7, rRoll=-3.7, lPitch=-29.0, lRoll=-11.2, bYaw=-2.9, bPitch=1.1, rlPitch=17.1, llPitch=2.9)),
        (0.075, E_LINEAR, P(rYaw=-43.1, rPitch=-44.8, rRoll=-4.9, lPitch=-32.2, lRoll=-12.6, bYaw=-3.3, bPitch=1.0, rlPitch=13.1, llPitch=5.3)),
        (0.100, E_LINEAR, P(rYaw=-35.2, rPitch=-40.0, rRoll=-8.5, lPitch=-41.2, lRoll=-15.0, bYaw=-4.5, bPitch=1.0, rlPitch=1.0, llPitch=10.8)),
        (0.125, E_LINEAR, P(rYaw=-32.0, rPitch=-37.9, rRoll=-10.0, lPitch=-45.1, lRoll=-16.0, bYaw=-5.0, bPitch=1.0, rlPitch=-4.1, llPitch=13.1)),
        (0.150, E_LINEAR, P(rYaw=-30.4, rPitch=-35.3, rRoll=-10.4, lPitch=-49.1, lRoll=-16.8, bYaw=-4.6, bPitch=0.8, rlPitch=-8.9, llPitch=15.5)),
        (0.175, E_LINEAR, P(rYaw=-27.4, rPitch=-30.5, rRoll=-11.2, lPitch=-56.6, lRoll=-18.3, bYaw=-3.8, bPitch=0.4, rlPitch=-17.9, llPitch=19.9)),
        (0.200, E_LINEAR, P(rYaw=-24.8, rPitch=-26.2, rRoll=-11.8, lPitch=-63.1, lRoll=-19.6, bYaw=-3.2, bPitch=0.1, rlPitch=-25.7, llPitch=23.9)),
        ...
        (0.600, E_LINEAR, P(rYaw=-31.3, rPitch=-138.9, rRoll=29.9, lYaw=-4.1, lPitch=-30.3, lRoll=6.4, bYaw=-6.3, bPitch=2.1, rlPitch=36.9, llPitch=-12.8)),
        (0.625, E_LINEAR, P(rYaw=-32.4, rPitch=-139.8, rRoll=31.6, lYaw=-2.4, lPitch=-26.0, lRoll=5.0, bYaw=-6.6, bPitch=1.2, rlPitch=34.0, llPitch=-10.8)),
        (0.650, E_LINEAR, P(rYaw=-33.2, rPitch=-140.4, rRoll=32.8, lYaw=-1.2, lPitch=-23.1, lRoll=4.0, bYaw=-6.8, bPitch=0.6, rlPitch=32.0, llPitch=-9.4)),
        (0.675, E_LINEAR, P(rYaw=-33.7, rPitch=-140.7, rRoll=33.5, lYaw=-0.5, lPitch=-21.3, lRoll=3.4, bYaw=-6.9, bPitch=0.3, rlPitch=30.9, llPitch=-8.6)),
        (0.700, E_LINEAR, P(rYaw=-33.9, rPitch=-140.9, rRoll=33.8, lYaw=-0.2, lPitch=-20.4, lRoll=3.1, bYaw=-7.0, bPitch=0.1, rlPitch=30.3, llPitch=-8.2)),
        (0.725, E_LINEAR, P(rYaw=-34.0, rPitch=-141.0, rRoll=34.0, lPitch=-20.0, lRoll=3.0, bYaw=-7.0, rlPitch=30.0, llPitch=-8.0)),
        (0.750, E_LINEAR, P(rYaw=-34.0, rPitch=-141.0, rRoll=34.0, lPitch=-20.0, lRoll=3.0, bYaw=-7.0, rlPitch=30.0, llPitch=-8.0)),
        (0.775, E_LINEAR, P(rYaw=-34.0, rPitch=-141.3, rRoll=35.1, lPitch=-18.6, lRoll=0.8, bYaw=-7.0, rlPitch=28.6, llPitch=-7.2)),
        (0.800, E_LINEAR, P(rYaw=-34.0, rPitch=-141.5, rRoll=36.0, lPitch=-17.6, lRoll=-0.9, bYaw=-7.0, rlPitch=27.6, llPitch=-6.5)),
        (0.825, E_LINEAR, P(rYaw=-34.0, rPitch=-141.7, rRoll=36.6, lPitch=-16.7, lRoll=-2.3, bYaw=-7.0, rlPitch=26.7, llPitch=-6.0)),
        (0.850, E_LINEAR, P(rYaw=-34.0, rPitch=-141.8, rRoll=37.1, lPitch=-16.1, lRoll=-3.3, bYaw=-7.0, rlPitch=26.1, llPitch=-5.6)),
        (0.875, E_LINEAR, P(rYaw=-34.0, rPitch=-141.9, rRoll=37.5, lPitch=-15.6, lRoll=-4.0, bYaw=-7.0, rlPitch=25.6, llPitch=-5.4)),
        (0.900, E_LINEAR, P(rYaw=-34.0, rPitch=-141.9, rRoll=37.7, lPitch=-15.3, lRoll=-4.5, bYaw=-7.0, rlPitch=25.3, llPitch=-5.2)),
        (0.925, E_LINEAR, P(rYaw=-34.0, rPitch=-142.0, rRoll=37.9, lPitch=-15.1, lRoll=-4.8, bYaw=-7.0, rlPitch=25.1, llPitch=-5.1)),
        (0.950, E_LINEAR, P(rYaw=-34.0, rPitch=-142.0, rRoll=38.0, lPitch=-15.0, lRoll=-4.9, bYaw=-7.0, rlPitch=25.0, llPitch=-5.0)),
        (0.975, E_LINEAR, P(rYaw=-34.0, rPitch=-142.0, rRoll=38.0, lPitch=-15.0, lRoll=-5.0, bYaw=-7.0, rlPitch=25.0, llPitch=-5.0)),
        (1.000, E_LINEAR, P(rYaw=-34.0, rPitch=-142.0, rRoll=38.0, lPitch=-15.0, lRoll=-5.0, bYaw=-7.0, rlPitch=25.0, llPitch=-5.0)),
    ],
    # --- hit3: smooth-дизайн v8, ЗЕРКАЛО применено (игровые стороны) ---
    [
        (0.000, E_LINEAR, P(rYaw=-34.0, rPitch=-142.0, rRoll=38.0, lPitch=-15.0, lRoll=-5.0, bYaw=-7.0, rlPitch=25.0, llPitch=-5.0)),
        (0.025, E_LINEAR, P(rYaw=-33.1, rPitch=-144.3, rRoll=35.7, lPitch=-20.9, lRoll=-6.5, bYaw=-6.7, rlPitch=17.7, llPitch=-1.3)),
        (0.050, E_LINEAR, P(rYaw=-31.0, rPitch=-150.0, rRoll=30.0, lPitch=-35.0, lRoll=-10.0, bYaw=-6.0, llPitch=7.5)),
        (0.075, E_LINEAR, P(rYaw=-28.9, rPitch=-155.7, rRoll=24.3, lPitch=-49.1, lRoll=-13.5, bYaw=-5.3, rlPitch=-17.7, llPitch=16.3)),
    ...
    # --- hit4: smooth-дизайн v8, ЗЕРКАЛО применено (игровые стороны) ---
    [
    ...
    # --- hit5: smooth-дизайн v8, ЗЕРКАЛО применено (игровые стороны) ---
    [
