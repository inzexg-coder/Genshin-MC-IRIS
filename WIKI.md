...
- В кроне созревают **1–2 плода-закатника**: красно-оранжевые шары, свисающие со случайных сторон кроны. Плод собирается кликом (ПКМ) или **ломается ударом меча (ЛКМ)** — выпадает **1–2 Закатника** (предмет).
