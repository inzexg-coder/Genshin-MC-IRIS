...
**Закатник (Sunsettia)** — плод Тейвата, растущий на одноимённом дереве. В Звездопадной Долине закатники генерируются **в обычном спавне леса наравне с дубами**: лес смешивает закатники и дубы (обычные и fancy). У закатника, как и у дуба, **несколько стилей** — компактное, широкое и высокое дерево — плюс внутри стиля случайность: высота ствола, густота кроны, пропуски угловых листьев, 0–2 плода. Светлая кора хвойного оттенка и оранжево-зелёная листва.

- В кроне созревает **0–2 плода-закатника**: красно-оранжевые небольшие шары (меньше листвы), свисающие со случайных сторон кроны (дерево может родиться и вовсе без плодов). Плод срывается кликом (ПКМ) или **ударом меча (ЛКМ)** с анимацией руки и россыпью частиц — выпадает **1–2 Закатника** (предмет). Сорванные плоды **отрастают со временем** (примерно через 1–3 минуты листва снова наращивает их, до 2 шт на дерево).
