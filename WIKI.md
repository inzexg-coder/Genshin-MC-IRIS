...
**Закатник (Sunsettia)** — плод Тейвата, растущий на одноимённом дереве. В Звездопадной Долине дерево встречается среди холмов у тропы. Это **среднее дерево** (ствол 4–6 блоков) со светлой корой хвойного оттенка и круглой кроной из оранжево-зелёной листвы.

- В кроне созревают **плоды-закатники**: красно-оранжевые шары, висящие на ветках. Сломав плод, можно получить **1–2 Закатника** (предмет).
