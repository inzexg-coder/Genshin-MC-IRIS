...
Карабканье доступно только у стен высотой **от двух блоков**. Одиночный блок — не стена: через него герой просто перешагивает обычным бегом (автоподъём).

Подойдите к стене и нажмите **Пробел** — герой вцепится в неё и начнёт карабкаться вверх.

Карабканье непрерывно тратит выносливость (**8 единиц в секунду**). Находясь на стене, повторно нажмите **Пробел**, чтобы рывком оттолкнуться — это стоит **20 единиц** выносливости:

- без движения — подскок вверх с места;
- при движении — прыжок в сторону движения (удобно забираться по диагонали);
- при движении назад — отрыв от стены (спрыгивание назад с поверхности).

Когда выносливость заканчивается, герой плавно сползает вниз по стене и, отпустив её, падает. Отпустите **Пробел** заранее, чтобы спрыгнуть со стены в любой момент.
