    ...
    #define INCLUDE_LIGHT_AND_AMBIENT_COLORS
        ...
        #ifndef COMPOSITE1
            vec3 noonClearLightColor = vec3(0.70, 0.60, 0.44) * 2.05; //ground and cloud color (Mondstadt gold)
        #else
        ...
        #endif
        vec3 nightClearAmbientColor   = 0.9 * vec3(0.075, 0.11, 0.21) * (1.55 + vsBrightness * 0.77); //indigo night
