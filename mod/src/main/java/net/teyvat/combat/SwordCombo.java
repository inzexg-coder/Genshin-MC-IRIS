...
public final class SwordCombo {
     ...
     *  (см. scripts/port_bc_combo.py): удар 1 — пролёт клинка слева направо,
     *  удар 2 — апперкот справа вверх, удар 3 — середина разворота, удар 4 —
     *  пролёт клинка справа налево, удар 5 — обрушение после замаха. */
    public static final int[] DAMAGE_TICKS = {5, 4, 9, 4, 6};
