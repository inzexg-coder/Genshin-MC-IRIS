...
public final class SwordCombo {
    ...
    /** Тик удара, в который наносится урон: пересчитан по пику скорости меча
     *  новых клипов (см. scripts/port_bc_combo.py): удар 1 — на 40% клипа
     *  (с учётом 15% старта из стойки), удары 2-4 — на 30-35%, удар 5 —
     *  на момент обрушения (~62% клипа). */
    public static final int[] DAMAGE_TICKS = {4, 3, 3, 3, 9};
