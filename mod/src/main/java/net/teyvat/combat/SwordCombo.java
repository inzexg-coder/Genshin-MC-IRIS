...
public final class SwordCombo {
    ...
    /** Длительность каждого удара в тиках (полный круг ≈ 3.5 сек — темп
     *  обычных атак Путешественника: удары 1-2 и 4 = 0.6 с, удар 3-разворот
     *  = 0.8 с, финальный широкий с прокатом = 0.9 с). Удар наносится в
     *  середине свинга, после замаха. */
    public static final int[] DURATION_TICKS = {12, 12, 16, 12, 18};
    /** Тик удара, в который наносится урон: середина свинга после замаха
     *  (см. scripts/gen_genshin_combo.py): удар 1 — пролёт клинка через
     *  фронт вправо, удар 2 — подъём диагонали через фронт, удар 3 —
     *  снижение клинка влево вниз (разворот), удар 4 — пролёт клинка через
     *  фронт влево, удар 5 — очень широкий разрез через весь фронт. */
    public static final int[] DAMAGE_TICKS = {6, 6, 9, 6, 10};
