 ...
 *      (корпус, голова и руки проворачиваются ровно на +2π);
...
public final class SwordCombo {
     ...
     *  замедлены, чтобы ощущались сильными: медленный замах -> быстрый рывок
     *  свинга -> плавное сопровождение). Удар наносится в середине свинга. */
     ...
     *  апперкот снизу вверх, удар 3 — разворот, удар 4 — пролёт справа налево,
     *  удар 5 — широкий замах с уводом клинка за спину. */
    public static final int[] DAMAGE_TICKS = {9, 7, 18, 9, 17};
