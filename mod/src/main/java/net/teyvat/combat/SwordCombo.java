...
public final class SwordCombo {
    ...
    /** Длительность каждого удара в тиках (полный круг ≈ 1.9 сек — плотная
     *  серия без пауз: удар 1 = 0.35 с, удары 2-3 = 0.35 с, удар 4 = 0.4 с,
     *  финальный разворот-обрушение = 0.45 с). */
    public static final int[] DURATION_TICKS = {7, 7, 7, 8, 9};
    /** Тик удара, в который наносится урон: пик скорости меча в новых клипах
     *  (см. scripts/port_bc_combo.py): удары 1-2 — конец свинга, удар 3 —
     *  середина восходящего разреза, удар 4 — момент выпада, удар 5 —
     *  обрушение вниз (~63% клипа). */
    public static final int[] DAMAGE_TICKS = {3, 3, 2, 2, 6};
