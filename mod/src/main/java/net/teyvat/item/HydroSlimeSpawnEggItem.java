...
/** Яйцо призыва гидро слайма: тестовый предмет для творческого режима.
 *  По правому клику спавнит обычного (не тренировочного) слайма туда,
 *  куда смотрит игрок. В выживании один экземпляр расходуется. */
public class HydroSlimeSpawnEggItem extends Item {
    private static final double RAYCAST_DISTANCE = 4.5;

    public HydroSlimeSpawnEggItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        slime.setPosition(pos.getX() + 0.5, pos.getY() + 0.05, pos.getZ() + 0.5);
