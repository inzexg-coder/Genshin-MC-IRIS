 ...
 *
 * Мир: море с севера до границы карты, пляж ~300 блоков, дальше — окраины.
 *   - северный край карты (мировой бордер, z = -2000) — дно моря (10 блоков воды);
 *   - урез воды около z = -1430, пляж до z = -1130, южнее — холмы окраин.
 *
 * Константы обязаны совпадать с data-паком:
 *  - teyvat_beach_height.json (сплайн профиля по g, он же континентальность биомов)
