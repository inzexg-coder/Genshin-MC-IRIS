 ...
 * ~180 блоков), с трёх сторон окружённая полями, поднимающимися пологими
 * склонами — пляж лежит в низине, без обрывов.
 *
...
public final class TeyvatXEdge {
     ...
     *  Полоса пляжа ~150 блоков в ширину, поля с обрывами по бокам. */
    public static final int BEACH_HALF = 75; // полоса пляжа между полями
