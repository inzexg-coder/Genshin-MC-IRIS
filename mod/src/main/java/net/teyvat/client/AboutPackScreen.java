 ...
 * крафта к сложному: описание, рецепт по центру). Экран администратора:
 * Shift+N или /teyvat notes, только для админов мира/сервера.
 */
public class AboutPackScreen extends Screen {
    ...
    public AboutPackScreen() {
        super(Text.literal("О сборке"));
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        String hint = "Колесо / стрелки — прокрутка · Esc — закрыть · Shift+N — «О сборке» (только админ)";
