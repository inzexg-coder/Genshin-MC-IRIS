    ...
    public static List<GuideTab> tabs() {
        return List.of(
                ...
                tab("combat", "Бой мечом", 0xFFFF8A8A, "sword",
                        "ЛКМ — серия из пяти ударов, как у Итэра и Люмин: широкий удар слева направо, диагональ снизу вверх, круговой разворот, удар справа налево и финальный очень широкий с прокатом.",
