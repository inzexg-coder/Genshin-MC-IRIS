 ...
 * без отскока в стойку), серия идёт непрерывно и быстро (полный круг ~2 с).
...
// Момент урона (середина быстрого сегмента клипа, доля клипа):
//   hit1_wide_l2r: u=0.46 -> DAMAGE_TICK=3
//   hit2_diag_r2l_up: u=0.48 -> DAMAGE_TICK=3
//   hit3_spin_circle: u=0.76 -> DAMAGE_TICK=7
//   hit4_slash_r2l: u=0.50 -> DAMAGE_TICK=4
//   hit5_wide_r2l_lunge: u=0.42 -> DAMAGE_TICK=4
    ...
    private static final Pose hit1_01 = new Pose(2.486553f, 2.040596f, 0.300000f, 0.000000f, -0.150000f, -0.150000f, 0.300000f, 0.000000f, 0.000000f, 0.220000f, -0.030000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit1_02 = new Pose(0.529912f, 1.840190f, 0.450000f, 0.000000f, -0.100000f, -0.150000f, 0.120000f, 0.000000f, 0.000000f, 0.100000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit1_03 = new Pose(-1.034132f, 0.975782f, 0.550000f, 0.000000f, 0.000000f, -0.100000f, -0.300000f, 0.000000f, 0.150000f, -0.220000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit1_04 = new Pose(-2.181589f, 1.352331f, 0.450000f, 0.000000f, 0.050000f, -0.050000f, -0.400000f, 0.000000f, 0.100000f, -0.280000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit1_05 = new Pose(-2.385993f, 1.265746f, 0.350000f, 0.000000f, -0.100000f, -0.050000f, -0.300000f, 0.000000f, 0.050000f, -0.200000f, 0.000000f, 0.000000f, 0.000000f, 0.020000f, 0.000000f, 0.000000f, 0.100000f, 0.000000f);
    private static final Pose hit1_06 = new Pose(-2.487621f, 0.880675f, 0.250000f, 0.000000f, -0.300000f, -0.100000f, -0.150000f, 0.030000f, 0.000000f, -0.100000f, -0.050000f, 0.000000f, 0.000000f, 0.020000f, 0.000000f, 0.000000f, 0.120000f, 0.000000f);
    // Удар 2: hit2_diag_r2l_up
    private static final Pose hit2_00 = new Pose(-2.487621f, 0.880675f, 0.250000f, 0.000000f, -0.300000f, -0.100000f, -0.150000f, 0.030000f, 0.000000f, -0.100000f, -0.050000f, 0.000000f, 0.000000f, 0.020000f, 0.000000f, 0.000000f, 0.120000f, 0.000000f);
    private static final Pose hit2_01 = new Pose(-2.305232f, 0.792342f, 0.200000f, 0.000000f, -0.250000f, -0.100000f, -0.250000f, 0.050000f, 0.000000f, -0.180000f, -0.120000f, 0.000000f, 0.000000f, -0.050000f, 0.000000f, 0.000000f, 0.120000f, 0.000000f);
    private static final Pose hit2_02 = new Pose(-0.639684f, 0.995609f, 0.400000f, 0.000000f, -0.150000f, -0.100000f, -0.050000f, 0.000000f, 0.000000f, -0.050000f, -0.050000f, 0.000000f, 0.000000f, -0.050000f, 0.000000f, 0.000000f, 0.120000f, 0.000000f);
    private static final Pose hit2_03 = new Pose(0.239485f, 2.644997f, 0.500000f, 0.000000f, 0.050000f, -0.050000f, 0.380000f, 0.000000f, 0.000000f, 0.280000f, -0.120000f, 0.000000f, 0.000000f, -0.050000f, 0.000000f, 0.000000f, 0.120000f, 0.000000f);
    private static final Pose hit2_04 = new Pose(2.400886f, 2.566976f, 0.400000f, 0.000000f, 0.100000f, 0.000000f, 0.480000f, 0.000000f, 0.000000f, 0.350000f, -0.100000f, 0.000000f, 0.000000f, -0.050000f, 0.000000f, 0.000000f, 0.120000f, 0.000000f);
    private static final Pose hit2_05 = new Pose(-1.986672f, 1.735833f, 0.500000f, -0.200000f, 0.150000f, 0.300000f, -0.550000f, 0.000000f, 0.000000f, -0.400000f, 0.150000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    // Удар 3: hit3_spin_circle
    private static final Pose hit3_00 = new Pose(-1.986672f, 1.735833f, 0.500000f, -0.200000f, 0.150000f, 0.300000f, -0.550000f, 0.000000f, 0.000000f, -0.400000f, 0.150000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit3_01 = new Pose(-0.751391f, 2.024389f, 0.500000f, -0.150000f, 0.300000f, 0.200000f, -0.250000f, 0.000000f, 0.000000f, -0.200000f, 0.150000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit3_02 = new Pose(-0.218216f, 1.792528f, 0.600000f, -0.100000f, 0.400000f, 0.150000f, 0.550000f, 0.000000f, 0.000000f, 0.420000f, 0.080000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit3_03 = new Pose(0.461115f, 1.985336f, 0.600000f, 0.100000f, 0.350000f, 0.100000f, 1.500000f, 0.000000f, 0.000000f, 1.150000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit3_04 = new Pose(2.381126f, 1.815335f, 0.500000f, 0.150000f, 0.150000f, 0.050000f, 2.450000f, 0.000000f, 0.000000f, 1.900000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit3_05 = new Pose(1.054862f, 1.186313f, 0.350000f, 0.100000f, 0.000000f, 0.000000f, 3.300000f, 0.100000f, 0.000000f, 2.550000f, 0.100000f, 0.000000f, 0.100000f, 0.150000f, 0.000000f, -0.100000f, -0.100000f, 0.000000f);
    private static final Pose hit3_06 = new Pose(-2.682866f, 1.701228f, 0.300000f, 0.000000f, 0.000000f, 0.050000f, 2.400000f, 0.050000f, 0.000000f, 1.900000f, 0.050000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit3_07 = new Pose(-2.250710f, 1.526471f, 0.400000f, -0.050000f, -0.050000f, 0.000000f, 1.000000f, 0.000000f, 0.000000f, 0.720000f, 0.050000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    // Удар 4: hit4_slash_r2l
    private static final Pose hit4_00 = new Pose(-2.250710f, 1.526471f, 0.400000f, -0.050000f, -0.050000f, 0.000000f, 1.000000f, 0.000000f, 0.000000f, 0.720000f, 0.050000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    private static final Pose hit4_01 = new Pose(-2.189599f, 1.587815f, 0.350000f, 0.000000f, -0.150000f, -0.100000f, 0.450000f, 0.000000f, 0.000000f, 0.330000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit4_02 = new Pose(-0.972760f, 1.089097f, 0.500000f, 0.000000f, -0.050000f, -0.100000f, 0.100000f, 0.000000f, 0.000000f, 0.080000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit4_03 = new Pose(0.993995f, 1.926723f, 0.550000f, 0.000000f, 0.050000f, -0.050000f, -0.300000f, 0.000000f, -0.150000f, -0.220000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit4_04 = new Pose(2.269192f, 2.084862f, 0.450000f, 0.000000f, 0.100000f, 0.000000f, -0.450000f, 0.000000f, -0.100000f, -0.300000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit4_05 = new Pose(-2.028409f, 1.472583f, 0.500000f, 0.000000f, -0.100000f, -0.050000f, 0.450000f, 0.000000f, 0.000000f, 0.350000f, 0.080000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    // Удар 5: hit5_wide_r2l_lunge
    private static final Pose hit5_00 = new Pose(-2.028409f, 1.472583f, 0.500000f, 0.000000f, -0.100000f, -0.050000f, 0.450000f, 0.000000f, 0.000000f, 0.350000f, 0.080000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit5_01 = new Pose(-1.986141f, 1.367641f, 0.550000f, 0.000000f, -0.200000f, -0.100000f, -0.350000f, 0.000000f, 0.000000f, -0.250000f, 0.100000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit5_02 = new Pose(-0.901510f, 1.021806f, 0.600000f, 0.000000f, -0.100000f, -0.100000f, -0.050000f, 0.000000f, 0.000000f, -0.050000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit5_03 = new Pose(0.385902f, 1.695588f, 0.600000f, 0.000000f, 0.050000f, -0.050000f, 0.350000f, 0.000000f, 0.100000f, 0.250000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit5_04 = new Pose(2.252267f, 2.026041f, 0.500000f, 0.100000f, 0.100000f, 0.000000f, 0.550000f, 0.000000f, 0.050000f, 0.400000f, 0.000000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit5_05 = new Pose(2.401172f, 2.151680f, 0.450000f, 0.150000f, 0.100000f, 0.000000f, 0.750000f, 0.050000f, 0.000000f, 0.550000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f, 0.000000f, 0.050000f, 0.000000f);
    private static final Pose hit5_06 = new Pose(2.608690f, 2.178534f, 0.450000f, 0.200000f, -0.100000f, -0.050000f, 0.900000f, 0.220000f, 0.000000f, 0.600000f, 0.150000f, 0.000000f, 0.000000f, -0.500000f, -0.060000f, 0.000000f, 0.620000f, 0.000000f);
    private static final Pose hit5_07 = new Pose(-3.141593f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, Float.NaN, Float.NaN, Float.NaN, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f);
    ...
    private static final Clip[] CLIPS = {
        new Clip(new Keyframe[] { // удар 1: hit1_wide_l2r
                new Keyframe(0.000f, 1, hit1_00),
                new Keyframe(0.140f, 1, hit1_01),
                new Keyframe(0.300f, 0, hit1_02),
                new Keyframe(0.460f, 0, hit1_03),
                new Keyframe(0.600f, 2, hit1_04),
                new Keyframe(0.780f, 4, hit1_05),
                new Keyframe(1.000f, 4, hit1_06),
        }),
        new Clip(new Keyframe[] { // удар 2: hit2_diag_r2l_up
                new Keyframe(0.000f, 1, hit2_00),
                new Keyframe(0.140f, 1, hit2_01),
                new Keyframe(0.320f, 0, hit2_02),
                new Keyframe(0.480f, 0, hit2_03),
                new Keyframe(0.620f, 2, hit2_04),
                new Keyframe(1.000f, 4, hit2_05),
        }),
        new Clip(new Keyframe[] { // удар 3: hit3_spin_circle
                new Keyframe(0.000f, 1, hit3_00),
                new Keyframe(0.150f, 1, hit3_01),
                new Keyframe(0.300f, 0, hit3_02),
                new Keyframe(0.450f, 0, hit3_03),
                new Keyframe(0.600f, 0, hit3_04),
                new Keyframe(0.760f, 2, hit3_05),
                new Keyframe(0.900f, 4, hit3_06),
                new Keyframe(1.000f, 4, hit3_07),
        }),
        new Clip(new Keyframe[] { // удар 4: hit4_slash_r2l
                new Keyframe(0.000f, 1, hit4_00),
                new Keyframe(0.160f, 1, hit4_01),
                new Keyframe(0.340f, 0, hit4_02),
                new Keyframe(0.500f, 0, hit4_03),
                new Keyframe(0.640f, 2, hit4_04),
                new Keyframe(1.000f, 4, hit4_05),
        }),
        new Clip(new Keyframe[] { // удар 5: hit5_wide_r2l_lunge
                new Keyframe(0.000f, 1, hit5_00),
                new Keyframe(0.120f, 1, hit5_01),
                new Keyframe(0.260f, 0, hit5_02),
                new Keyframe(0.420f, 0, hit5_03),
                new Keyframe(0.560f, 2, hit5_04),
                new Keyframe(0.700f, 2, hit5_05),
                new Keyframe(0.860f, 4, hit5_06),
                new Keyframe(1.000f, 4, hit5_07),
        }),
    };
