...
public record QuestStatePayload(boolean meetPaimon, boolean tryScroll) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, QuestStatePayload> CODEC = PacketCodec.of(
            ...
            buf -> new QuestStatePayload(buf.readBoolean(), buf.readBoolean()));
