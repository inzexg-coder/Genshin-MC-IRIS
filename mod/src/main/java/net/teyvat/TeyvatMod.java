...
import net.teyvat.worldgen.SunsettiaTreeFeature;
...
public class TeyvatMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        FabricDefaultAttributeRegistry.register(BlueHornedLizardEntity.TYPE, BlueHornedLizardEntity.createAttributes());
